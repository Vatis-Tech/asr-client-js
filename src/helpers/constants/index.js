...
const SOCKET_IO_CLIENT_RESPONSE_FINAL_PACKET = "FinalPacket";
...
const SOCKET_IO_CLIENT_MESSAGE_TYPE_CONFIG = "CONFIG";
const SOCKET_IO_CLIENT_MESSAGE_TYPE_DATA = "DATA";
const SOCKET_IO_SERVER_MESSAGE_TYPE_CONFIG_APPLIED = "CONFIG_APPLIED";
